            ...
            series: [
                {
                    ...
                    splitLine: {
                        length: 0, // Establece la longitud de las líneas en cero para ocultarlas
                        lineStyle: {
                            color: 'auto',
                            width: 2
                        }
                    ...
                    axisLabel: {
                        ...
                        formatter: (value:number) => {
                            ...
                            if (value === 100) {        //100-80
                                // return 'Muy Bueno'; 
                            } else if (value === 80) { //80-60
                                // return 'Bueno';
                            } else if (value === 60) { //60-40
                                // return 'Normal';
                            } else if (value === 40) { //40-20
                                // return 'Malo';
                    ...
                    data: [
                        {
                            value: totalMediaClase, // Usa el valor calculado para esta clase
